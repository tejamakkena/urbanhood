-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('RENTER', 'SUPPLIER', 'ADMIN');

-- CreateEnum
CREATE TYPE "ListingCategory" AS ENUM ('CHAIRS', 'TABLES', 'LINENS', 'DECOR', 'TENTS', 'LIGHTING', 'AUDIO_VISUAL', 'TABLEWARE', 'INFLATABLES', 'OTHER');

-- CreateEnum
CREATE TYPE "ListingStatus" AS ENUM ('PENDING_REVIEW', 'ACTIVE', 'INACTIVE', 'REJECTED');
